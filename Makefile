...
#    Updated: 2024/06/28 16:27:14 by rpocater         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME	=	minishell
SRC		=	src/
CFILES	=	main.c execute.c parse.c tokenize.c env.c expansor.c utils_expansor.c signals.c utils_token.c add_tokens.c list_to_matrix.c
